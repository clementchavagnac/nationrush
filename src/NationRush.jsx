...
/* ─ Cloud (Supabase) chargé dynamiquement : l'aperçu marche sans, et
   en production les vraies fonctions sont chargées au runtime. ─ */
let CLOUD = null;
let _cloudLoading = false;
function loadCloud(){
  if(CLOUD||_cloudLoading) return;
  _cloudLoading = true;
  import("./cloud").then(m=>{ CLOUD = m; }).catch(()=>{ CLOUD = null; });
}
loadCloud();
const cloudEnabled            = () => !!(CLOUD && CLOUD.cloudEnabled && CLOUD.cloudEnabled());
const ensureSession           = (...a) => CLOUD?.ensureSession?.(...a) ?? Promise.resolve(null);
const getProfile              = (...a) => CLOUD?.getProfile?.(...a) ?? Promise.resolve(null);
const updateProfile           = (...a) => CLOUD?.updateProfile?.(...a) ?? Promise.resolve();
const submitScore             = (...a) => CLOUD?.submitScore?.(...a) ?? Promise.resolve();
const getLeaderboard          = (...a) => CLOUD?.getLeaderboard?.(...a) ?? Promise.resolve([]);
const getMyRank               = (...a) => CLOUD?.getMyRank?.(...a) ?? Promise.resolve(null);
const getFriendsLeaderboard   = (...a) => CLOUD?.getFriendsLeaderboard?.(...a) ?? Promise.resolve([]);
const addFriend               = (...a) => CLOUD?.addFriend?.(...a) ?? Promise.resolve("offline");
...
/* ── LOT 3 ── */
R("chevres","Pays avec le plus de chèvres","🐐",3,"FAO 2024",[
  {nm:"Inde",f:"🇮🇳"},{nm:"Chine",f:"🇨🇳"},{nm:"Pakistan",f:"🇵🇰"},
  {nm:"Nigeria",f:"🇳🇬"},{nm:"Bangladesh",f:"🇧🇩"},{nm:"Soudan",f:"🇸🇩"},
  {nm:"Kenya",f:"🇰🇪"},{nm:"Tchad",f:"🇹🇩"},{nm:"Éthiopie",f:"🇪🇹"},{nm:"Mali",f:"🇲🇱"}]),
R("the","Pays produisant le plus de thé","🍵",2,"FAO 2024",[
  {nm:"Chine",f:"🇨🇳"},{nm:"Inde",f:"🇮🇳"},{nm:"Kenya",f:"🇰🇪"},
  {nm:"Sri Lanka",f:"🇱🇰"},{nm:"Turquie",f:"🇹🇷"},{nm:"Vietnam",f:"🇻🇳"},
  {nm:"Indonésie",f:"🇮🇩"},{nm:"Argentine",f:"🇦🇷"},{nm:"Japon",f:"🇯🇵"},{nm:"Iran",f:"🇮🇷"}]),
R("sucre","Pays produisant le plus de sucre","🍬",3,"FAO 2024",[
  {nm:"Brésil",f:"🇧🇷"},{nm:"Inde",f:"🇮🇳"},{nm:"Chine",f:"🇨🇳"},
  {nm:"Thaïlande",f:"🇹🇭"},{nm:"États-Unis",f:"🇺🇸"},{nm:"Pakistan",f:"🇵🇰"},
  {nm:"Mexique",f:"🇲🇽"},{nm:"Russie",f:"🇷🇺"},{nm:"Australie",f:"🇦🇺"},{nm:"France",f:"🇫🇷"}]),
R("bananes","Pays produisant le plus de bananes","🍌",2,"FAO 2024",[
  {nm:"Inde",f:"🇮🇳"},{nm:"Chine",f:"🇨🇳"},{nm:"Indonésie",f:"🇮🇩"},
  {nm:"Brésil",f:"🇧🇷"},{nm:"Équateur",f:"🇪🇨"},{nm:"Philippines",f:"🇵🇭"},
  {nm:"Guatemala",f:"🇬🇹"},{nm:"Angola",f:"🇦🇴"},{nm:"Tanzanie",f:"🇹🇿"},{nm:"Colombie",f:"🇨🇴"}]),
R("chocolat_prod","Pays produisant le plus de cacao","🍫",3,"ICCO 2024",[
  {nm:"Côte d'Ivoire",f:"🇨🇮"},{nm:"Ghana",f:"🇬🇭"},{nm:"Indonésie",f:"🇮🇩"},
  {nm:"Équateur",f:"🇪🇨"},{nm:"Cameroun",f:"🇨🇲"},{nm:"Nigeria",f:"🇳🇬"},
  {nm:"Brésil",f:"🇧🇷"},{nm:"Pérou",f:"🇵🇪"},{nm:"RD Congo",f:"🇨🇩"},{nm:"Colombie",f:"🇨🇴"}]),
R("ponts","Pays avec les plus hauts ponts","🌉",3,"Données d'ingénierie 2024",[
  {nm:"Chine",f:"🇨🇳"},{nm:"France",f:"🇫🇷"},{nm:"Mexique",f:"🇲🇽"},
  {nm:"Suisse",f:"🇨🇭"},{nm:"Italie",f:"🇮🇹"},{nm:"États-Unis",f:"🇺🇸"},
  {nm:"Inde",f:"🇮🇳"},{nm:"Japon",f:"🇯🇵"},{nm:"Norvège",f:"🇳🇴"},{nm:"Colombie",f:"🇨🇴"}]),
R("metro","Pays avec les plus grands réseaux de métro","🚇",3,"Données transport 2024",[
  {nm:"Chine",f:"🇨🇳"},{nm:"États-Unis",f:"🇺🇸"},{nm:"Corée du Sud",f:"🇰🇷"},
  {nm:"Inde",f:"🇮🇳"},{nm:"Japon",f:"🇯🇵"},{nm:"Russie",f:"🇷🇺"},
  {nm:"Royaume-Uni",f:"🇬🇧"},{nm:"Allemagne",f:"🇩🇪"},{nm:"France",f:"🇫🇷"},{nm:"Espagne",f:"🇪🇸"}]),
R("langues","Pays avec le plus de langues parlées","🗣️",3,"Ethnologue 2024",[
  {nm:"Papouasie-Nouvelle-Guinée",f:"🇵🇬"},{nm:"Indonésie",f:"🇮🇩"},{nm:"Nigeria",f:"🇳🇬"},
  {nm:"Inde",f:"🇮🇳"},{nm:"Chine",f:"🇨🇳"},{nm:"Mexique",f:"🇲🇽"},
  {nm:"Cameroun",f:"🇨🇲"},{nm:"Australie",f:"🇦🇺"},{nm:"États-Unis",f:"🇺🇸"},{nm:"Brésil",f:"🇧🇷"}]),
R("iles","Pays avec le plus d'îles","🏝️",3,"Données géographiques 2024",[
  {nm:"Suède",f:"🇸🇪"},{nm:"Norvège",f:"🇳🇴"},{nm:"Finlande",f:"🇫🇮"},
  {nm:"Canada",f:"🇨🇦"},{nm:"Indonésie",f:"🇮🇩"},{nm:"Australie",f:"🇦🇺"},
  {nm:"Philippines",f:"🇵🇭"},{nm:"Japon",f:"🇯🇵"},{nm:"Chili",f:"🇨🇱"},{nm:"Royaume-Uni",f:"🇬🇧"}]),
R("volcans","Pays avec le plus de volcans","🌋",3,"Smithsonian GVP 2024",[
  {nm:"États-Unis",f:"🇺🇸"},{nm:"Russie",f:"🇷🇺"},{nm:"Indonésie",f:"🇮🇩"},
  {nm:"Japon",f:"🇯🇵"},{nm:"Chili",f:"🇨🇱"},{nm:"Éthiopie",f:"🇪🇹"},
  {nm:"Papouasie-Nouvelle-Guinée",f:"🇵🇬"},{nm:"Philippines",f:"🇵🇭"},{nm:"Mexique",f:"🇲🇽"},{nm:"Islande",f:"🇮🇸"}]),
R("pluie","Pays avec le plus de précipitations","🌧️",3,"Données climatiques 2024",[
  {nm:"Colombie",f:"🇨🇴"},{nm:"Papouasie-Nouvelle-Guinée",f:"🇵🇬"},{nm:"Malaisie",f:"🇲🇾"},
  {nm:"Indonésie",f:"🇮🇩"},{nm:"Brunei",f:"🇧🇳"},{nm:"Bangladesh",f:"🇧🇩"},
  {nm:"Costa Rica",f:"🇨🇷"},{nm:"Philippines",f:"🇵🇭"},{nm:"Brésil",f:"🇧🇷"},{nm:"Singapour",f:"🇸🇬"}]),
R("electrique","Pays avec le plus de voitures électriques","🔋",2,"AIE 2024",[
  {nm:"Chine",f:"🇨🇳"},{nm:"États-Unis",f:"🇺🇸"},{nm:"Allemagne",f:"🇩🇪"},
  {nm:"Royaume-Uni",f:"🇬🇧"},{nm:"France",f:"🇫🇷"},{nm:"Norvège",f:"🇳🇴"},
  {nm:"Pays-Bas",f:"🇳🇱"},{nm:"Corée du Sud",f:"🇰🇷"},{nm:"Suède",f:"🇸🇪"},{nm:"Japon",f:"🇯🇵"}]),
R("aeroport_trafic","Pays avec le trafic aérien le plus dense","🛬",2,"ACI 2024",[
  {nm:"États-Unis",f:"🇺🇸"},{nm:"Chine",f:"🇨🇳"},{nm:"Royaume-Uni",f:"🇬🇧"},
  {nm:"Japon",f:"🇯🇵"},{nm:"Allemagne",f:"🇩🇪"},{nm:"Espagne",f:"🇪🇸"},
  {nm:"Inde",f:"🇮🇳"},{nm:"Émirats arabes unis",f:"🇦🇪"},{nm:"France",f:"🇫🇷"},{nm:"Turquie",f:"🇹🇷"}]),
R("billets","Pays les plus visités par les touristes chinois","🧳",3,"Données tourisme 2024",[
  {nm:"Thaïlande",f:"🇹🇭"},{nm:"Japon",f:"🇯🇵"},{nm:"Corée du Sud",f:"🇰🇷"},
  {nm:"Vietnam",f:"🇻🇳"},{nm:"Singapour",f:"🇸🇬"},{nm:"Malaisie",f:"🇲🇾"},
  {nm:"États-Unis",f:"🇺🇸"},{nm:"Australie",f:"🇦🇺"},{nm:"Italie",f:"🇮🇹"},{nm:"France",f:"🇫🇷"}]),
R("startup_eco","Pays avec le meilleur écosystème tech","💻",3,"StartupBlink 2024",[
  {nm:"États-Unis",f:"🇺🇸"},{nm:"Royaume-Uni",f:"🇬🇧"},{nm:"Israël",f:"🇮🇱"},
  {nm:"Canada",f:"🇨🇦"},{nm:"Allemagne",f:"🇩🇪"},{nm:"Chine",f:"🇨🇳"},
  {nm:"Inde",f:"🇮🇳"},{nm:"France",f:"🇫🇷"},{nm:"Australie",f:"🇦🇺"},{nm:"Singapour",f:"🇸🇬"}]),
];
...
// Partie standard (lancement simple, recommandé)
const NORMAL_PRESET={id:"normal",icon:"🎮",name:"Partie normale",rounds:10,maxH:11,timer:0,chaos:false,fake:false};
...
html,body{height:100%;background:#0a0e1a;color:#1C1C1E;-webkit-font-smoothing:antialiased;overscroll-behavior:none}
#root{height:100%}
...
.overlay-dark{position:fixed;inset:0;background:rgba(6,10,20,.78);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);z-index:60;display:flex;align-items:center;justify-content:center;padding:16px}
.sheet-glass{width:100%;max-width:450px;padding:24px 20px;border-radius:22px;position:relative;
  background:linear-gradient(160deg,rgba(255,255,255,.12),rgba(255,255,255,.04));
  border:1.5px solid rgba(255,255,255,.16);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);
  box-shadow:0 20px 60px rgba(0,0,0,.5),inset 0 1px 1px rgba(255,255,255,.2)}
.sheet-glass::before{content:"";position:absolute;top:0;left:24px;right:24px;height:1px;background:linear-gradient(90deg,transparent,rgba(255,255,255,.4),transparent)}
...
/* ── Cartes mode futuristes (glassmorphism néon) ── */
.gcard{position:relative;border-radius:16px;padding:.95rem .85rem;cursor:pointer;overflow:hidden;
  background:linear-gradient(145deg,rgba(255,255,255,.09),rgba(255,255,255,.03));
  border:1.5px solid rgba(255,255,255,.14);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);
  transition:all .2s cubic-bezier(.4,0,.2,1)}
.gcard::before{content:"";position:absolute;top:0;left:0;right:0;height:1px;background:linear-gradient(90deg,transparent,rgba(255,255,255,.35),transparent)}
.gcard:active{transform:scale(.97)}
.gcard.on{border-color:transparent}
.gicon{width:42px;height:42px;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.45rem;flex-shrink:0;box-shadow:0 3px 12px rgba(0,0,0,.3),inset 0 1px 1px rgba(255,255,255,.3)}
.gplay{position:relative;border-radius:18px;overflow:hidden;border:none;cursor:pointer;width:100%;
  background:linear-gradient(135deg,#0066FF,#3B9EFF);
  box-shadow:0 0 0 1px rgba(255,255,255,.15),0 8px 30px rgba(0,102,255,.5),inset 0 1px 1px rgba(255,255,255,.4);
  transition:all .15s cubic-bezier(.4,0,.2,1)}
.gplay::after{content:"";position:absolute;inset:0;background:linear-gradient(90deg,transparent,rgba(255,255,255,.18),transparent);transform:translateX(-100%);animation:shine 3.5s ease-in-out infinite}
@keyframes shine{0%,60%{transform:translateX(-100%)}100%{transform:translateX(100%)}}
.gplay:active{transform:translateY(2px) scale(.99)}
.gpill{position:relative;border-radius:13px;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:.45rem;
  background:linear-gradient(145deg,rgba(255,255,255,.1),rgba(255,255,255,.04));
  border:1.5px solid rgba(255,255,255,.16);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);
  transition:all .15s}
.gpill:active{transform:scale(.95)}
/* ── Panneaux de jeu en verre dépoli (texte clair) ── */
.gp{background:linear-gradient(145deg,rgba(255,255,255,.1),rgba(255,255,255,.035));border:1.5px solid rgba(255,255,255,.15);border-radius:16px;backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);box-shadow:0 8px 28px rgba(0,0,0,.32),inset 0 1px 1px rgba(255,255,255,.18);position:relative}
.gp-sm{background:linear-gradient(145deg,rgba(255,255,255,.09),rgba(255,255,255,.03));border:1.5px solid rgba(255,255,255,.13);border-radius:13px;backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);box-shadow:0 4px 16px rgba(0,0,0,.25)}
.gp-input{width:100%;box-sizing:border-box;background:linear-gradient(145deg,rgba(255,255,255,.97),rgba(240,245,255,.95));border:1.5px solid rgba(255,255,255,.6);border-radius:15px;padding:0 18px;color:#1C1C1E;font-size:1.02rem;font-weight:600;transition:border-color .18s,box-shadow .18s;box-shadow:0 4px 18px rgba(0,0,0,.28),inset 0 1px 2px rgba(255,255,255,.8);outline:none}
.gp-input:focus{border-color:#3B9EFF;box-shadow:0 0 0 3px rgba(0,102,255,.3),0 0 22px rgba(0,102,255,.35),inset 0 1px 2px rgba(255,255,255,.8)}
.gp-input::placeholder{color:#9A9AA0;font-weight:500}
...
export default function NationRush(){
  /* ─ screens & game type ─ */
  const [scr,  setScrn] = useState("home");
  const [gt,   setGT]   = useState("world");  // "world"|"rankings"|"france"

  /* ─ Cloud (Supabase) ─ */
  const [profile, setProfile] = useState(null);     // {pseudo, avatar, friend_code}
  const [lbMode, setLbMode]   = useState("world");  // mode affiché dans le classement
  const [lbTab, setLbTab]     = useState("world");  // "world" | "friends"
  ...
  const [showChals, setShowChals] = useState(false);

  /* ─ Écran de règles avant lancement ─ */
  const [rulesMode, setRulesMode] = useState(null);   // mode dont on affiche les règles
  const [pendingCfg, setPendingCfg] = useState(null); // config en attente (presets world/france)
  const [rulesPage, setRulesPage] = useState(0);      // page du carrousel de règles
  const [hideRules, setHideRules] = useState(()=>{try{return JSON.parse(localStorage.getItem("nr_hiderules")||"{}")}catch{return {}}}); // {mode:true}
  const audioStarted = useRef(false);
  const rulesTouch = useRef(0);
  ...
  /* ─ Init cloud : connexion anonyme + chargement du profil ─ */
  const [cloudReady, setCloudReady] = useState(false);
  useEffect(()=>{
    let tries=0;
    const iv=setInterval(()=>{
      tries++;
      if(cloudEnabled()){ setCloudReady(true); clearInterval(iv);
        (async()=>{ await ensureSession(); const p=await getProfile(); if(p) setProfile(p); })();
      }
      if(tries>20) clearInterval(iv); // abandonne après ~2s (mode hors-ligne)
    },100);
    return ()=>clearInterval(iv);
  },[]);

  /* ─ Charger un classement (mondial ou amis) ─ */
  const loadLeaderboard = useCallback(async(mode, tab)=>{
    if(!cloudEnabled()) return;
    setLbLoading(true);
    try{
      if(tab==="friends"){
        const rows = await getFriendsLeaderboard(mode);
        setLbRows(rows); setLbRank(null);
      } else {
        const [rows, rank] = await Promise.all([getLeaderboard(mode,100), getMyRank(mode)]);
        setLbRows(rows); setLbRank(rank);
      }
    } finally { setLbLoading(false); }
  },[]);

  /* ═══════════ PARTAGE VIRAL ═══════════ */
  const SHARE_URL = "https://nationrush.netlify.app"; // ← remplace par ton vrai lien
  const [shareMsg, setShareMsg] = useState("");

  // Construit la grille emoji + texte selon le mode
  const buildShareText = useCallback((mode, data)=>{
    const L = {world:"🌍 Pays du Monde", france:"🇫🇷 Villes de France", rankings:"🏆 Top 10 Mondial", highlow:"⬆️ Plus ou Moins"}[mode]||"Nation Rush";
    let grid="", line2="";
    if(mode==="world"||mode==="france"){
      // data.results = tableau de points par manche (10,8,6,4,2,1,0)
      grid = (data.results||[]).map(p=> p>=8?"🟩":p>=4?"🟨":p>0?"🟧":"⬜").join("");
      line2 = `${data.score} pts · ${(data.results||[]).filter(p=>p>0).length}/${(data.results||[]).length} trouvés`;
    } else if(mode==="rankings"){
      // data.rounds = [{found:7},{found:10},{found:4}]
      grid = (data.rounds||[]).map(r=>{
        const f=r.found||0; return f===10?"🟩":f>=7?"🟨":f>=4?"🟧":"🟥";
      }).join(" ");
      line2 = `${data.score} pts · ${(data.rounds||[]).reduce((a,r)=>a+(r.found||0),0)}/30 pays`;
    } else if(mode==="highlow"){
      const s=data.score||0;
      grid = "🔥".repeat(Math.min(s,10)) + (s>10?` +${s-10}`:"");
      line2 = `Série de ${s} bonnes réponses`;
    }
    return `Nation Rush — ${L}\n${grid}\n${line2}\n\n👉 Bats mon score : ${SHARE_URL}`;
  },[]);

  // Dessine une jolie image (canvas) à partager / télécharger
  const buildShareImage = useCallback((mode, data)=>{
    return new Promise(resolve=>{
      const W=1080, H=1080;
      const cv=document.createElement("canvas"); cv.width=W; cv.height=H;
      const x=cv.getContext("2d");
      const themes={world:["#0066FF","#3B9EFF"],france:["#1B4FBB","#4F8BFF"],rankings:["#FF9F0A","#FFD60A"],highlow:["#32D74B","#5be36a"]};
      const [c1,c2]=themes[mode]||["#0066FF","#3B9EFF"];
      // fond dégradé
      const g=x.createLinearGradient(0,0,W,H); g.addColorStop(0,"#0a0e1a"); g.addColorStop(1,"#11182e");
      x.fillStyle=g; x.fillRect(0,0,W,H);
      // halo
      const rg=x.createRadialGradient(W/2,360,0,W/2,360,520); rg.addColorStop(0,c1+"55"); rg.addColorStop(1,"#0a0e1a00");
      x.fillStyle=rg; x.fillRect(0,0,W,H);
      x.textAlign="center";
      // titre
      x.fillStyle="#fff"; x.font="900 64px -apple-system,Segoe UI,Roboto,sans-serif";
      x.fillText("NATION RUSH", W/2, 180);
      const L={world:"🌍 Pays du Monde",france:"🇫🇷 Villes de France",rankings:"🏆 Top 10 Mondial",highlow:"⬆️ Plus ou Moins"}[mode]||"";
      x.fillStyle=c2; x.font="700 42px -apple-system,Segoe UI,Roboto,sans-serif";
      x.fillText(L, W/2, 248);
      // score géant
      x.fillStyle="#fff"; x.font="900 280px -apple-system,Segoe UI,Roboto,sans-serif";
      x.fillText(String(data.score??data.scoreText??0), W/2, 620);
      x.fillStyle="rgba(255,255,255,.6)"; x.font="600 40px -apple-system,Segoe UI,Roboto,sans-serif";
      x.fillText("POINTS", W/2, 690);
      // grille emoji
      const txt=buildShareText(mode,data).split("\n");
      x.font="64px -apple-system,Segoe UI,Roboto,sans-serif";
      x.fillStyle="#fff"; x.fillText(txt[1]||"", W/2, 820);
      x.font="600 38px -apple-system,Segoe UI,Roboto,sans-serif"; x.fillStyle="rgba(255,255,255,.85)";
      x.fillText(txt[2]||"", W/2, 890);
      // CTA bas
      x.fillStyle=c1; x.fillRect(140,960,800,90);
      x.fillStyle="#fff"; x.font="800 40px -apple-system,Segoe UI,Roboto,sans-serif";
      x.fillText("Bats mon score → nationrush", W/2, 1018);
      cv.toBlob(b=>resolve(b),"image/png");
    });
  },[buildShareText]);

  // Action de partage (image si possible, sinon texte) + repli copier
  const doShare = useCallback(async(mode, data)=>{
    sfx("tap");
    const text = buildShareText(mode, data);
    try{
      const blob = await buildShareImage(mode, data);
      const file = blob ? new File([blob],"nationrush.png",{type:"image/png"}) : null;
      if(file && navigator.canShare && navigator.canShare({files:[file]})){
        await navigator.share({ files:[file], text });
        return;
      }
      if(navigator.share){ await navigator.share({ text, url:SHARE_URL }); return; }
      // repli desktop : copier le texte + télécharger l'image
      await navigator.clipboard.writeText(text);
      if(blob){ const u=URL.createObjectURL(blob); const a=document.createElement("a"); a.href=u; a.download="nationrush.png"; a.click(); URL.revokeObjectURL(u); }
      setShareMsg("Copié + image téléchargée !"); setTimeout(()=>setShareMsg(""),2500);
    }catch(e){
      // l'utilisateur a annulé le partage natif → on ignore
      if(e?.name!=="AbortError"){
        try{ await navigator.clipboard.writeText(text); setShareMsg("Score copié !"); setTimeout(()=>setShareMsg(""),2500);}catch{}
      }
    }
  },[buildShareText,buildShareImage]);
  ...
  const G        = useRef({});
  G.current={scr,gt,cfg,q,qi,hints,hi,phase,score,hsW,hsR,hsF,hsHL,hsIM,imScore,imRound,rOk,maxCombo,rScore,hlScore};
  ...
  const saveHs=useCallback((sc,g)=>{
    ...
    submitScore(g==="france"?"france":"world", sc);
  },[]);
  ...
  /* Envoi fiable du score Top 10 : dès qu'on atteint game_end, avec le score à jour.
     Fonctionne quel que soit le chemin (3 manches finies OU bouton "résultat final"). */
  const rSentRef = useRef(false);
  useEffect(()=>{
    if(rPhase==="game_end" && !rSentRef.current){
      rSentRef.current = true;
      submitScore("rankings", rScore);
    }
    if(rPhase==="playing" && rRound===1) rSentRef.current = false; // reset pour la partie suivante
  },[rPhase,rScore,rRound]);
  ...
  const RULES = {
    world: {
      icon:"🌍", color:"#0066FF", title:"Pays du Monde",
      pages:[
        {emoji:"🌍", h:"Devine le pays mystère", p:"Un pays est caché. À toi de le retrouver grâce aux indices qui se dévoilent un par un."},
        {emoji:"💡", h:"Des indices progressifs", p:"Tu commences avec un seul indice (continent, capitale, drapeau…). Tape ta réponse, ou demande un indice de plus si tu sèches."},
        {emoji:"⚠️", h:"Attention aux points !", p:"Chaque indice supplémentaire fait baisser tes points : 10 → 8 → 6 → 4 → 2 → 1. Plus tu trouves tôt, plus tu marques.", warn:true},
        {emoji:"🏆", h:"Marque un maximum", p:"Trouve dès le 1ᵉʳ indice pour 10 points. Ton meilleur score est sauvegardé."},
      ],
    },
    france: {
      icon:"🇫🇷", color:"#1B4FBB", title:"Villes de France",
      pages:[
        {emoji:"🇫🇷", h:"Devine la ville mystère", p:"Une ville française est cachée. Retrouve-la grâce aux indices."},
        {emoji:"💡", h:"Des indices progressifs", p:"Région, monument, spécialité culinaire… Tape ta réponse ou demande un indice de plus."},
        {emoji:"⚠️", h:"Attention aux points !", p:"Chaque indice supplémentaire fait baisser tes points : 10 → 8 → 6 → 4 → 2 → 1.", warn:true},
        {emoji:"🏆", h:"Marque un maximum", p:"Plus tu trouves tôt, plus tu marques. Ton record est sauvegardé."},
      ],
    },
    rankings: {
      icon:"🏆", color:"#FF9F0A", title:"Top 10 Mondial",
      pages:[
        {emoji:"🏆", h:"Retrouve le Top 10", p:"Une catégorie est donnée (ex. pays les plus peuplés). À toi de retrouver les 10 pays du classement."},
        {emoji:"⌨️", h:"Tape tes réponses", p:"Écris les noms des pays que tu penses être dans le Top 10. Chaque bonne réponse remplit une case."},
        {emoji:"❤️", h:"3 vies par manche", p:"Attention : 3 erreurs et la manche s'arrête. La partie compte 3 manches au total.", warn:true},
        {emoji:"💯", h:"Le score", p:"2 points par pays trouvé, +3 bonus si tu en trouves 5 ou plus, +10 si tu fais les 10 !"},
      ],
    },
    highlow: {
      icon:"⬆️", color:"#32D74B", title:"Plus ou Moins",
      pages:[
        {emoji:"⬆️", h:"Mieux ou moins bien classé ?", p:"Un pays s'affiche avec son rang dans un classement (ex. #4 sur 50)."},
        {emoji:"❓", h:"Le pays suivant", p:"Un second pays apparaît, mais son rang est caché. À toi de deviner."},
        {emoji:"🎯", h:"Fais ton choix", p:"Le 2ᵉ pays est-il MIEUX classé ⬆️ ou MOINS BIEN classé ⬇️ que le précédent ?"},
        {emoji:"🔥", h:"Enchaîne les bonnes réponses", p:"Bonne réponse = +1 et la série continue. Mauvaise = tu perds une vie (3 vies). Combo illimité !", warn:true},
      ],
    },
  };

  const openRules = useCallback((mode, cfg=null)=>{
    AudioEngine.playSfx("tap");
    // Si l'utilisateur a choisi de ne plus voir les règles de ce mode, on lance direct
    if(hideRules[mode]){
      if(mode==="rankings") startRanking();
      else if(mode==="highlow") startHL();
      else startGame(cfg||{...NORMAL_PRESET,diff:[1,2,3,4],region:"all"}, mode);
      return;
    }
    setPendingCfg(cfg);
    setRulesPage(0);
    setRulesMode(mode);
  },[hideRules,startRanking,startHL,startGame]);

  const launchFromRules = useCallback((dontShowAgain)=>{
    const mode=rulesMode, cfg=pendingCfg;
    if(dontShowAgain){
      setHideRules(h=>{const nh={...h,[mode]:true};try{localStorage.setItem("nr_hiderules",JSON.stringify(nh))}catch{};return nh;});
    }
    setRulesMode(null); setPendingCfg(null); setRulesPage(0);
    if(mode==="rankings") startRanking();
    else if(mode==="highlow") startHL();
    else startGame(cfg||{...NORMAL_PRESET,diff:[1,2,3,4],region:"all"}, mode);
  },[rulesMode,pendingCfg,startRanking,startHL,startGame]);
  ...
  const xpOverlay=(
    <>
      ...
      {levelUp&&(
        <div className="overlay-dark" style={{zIndex:95}} onClick={()=>setLevelUp(null)}>
          <div className="sheet-glass ashu" style={{textAlign:"center",maxWidth:"320px"}} onClick={e=>e.stopPropagation()}>
            <div style={{fontSize:"3.2rem",marginBottom:".4rem"}}>⭐</div>
            <div style={{fontSize:".7rem",fontWeight:800,color:"#32D74B",letterSpacing:".1em",textTransform:"uppercase",marginBottom:".3rem"}}>Niveau supérieur !</div>
            <div style={{fontWeight:800,fontSize:"2.6rem",color:"#fff",letterSpacing:"-.03em",lineHeight:1}}>Niveau {levelUp}</div>
            <div style={{fontSize:".82rem",color:"rgba(255,255,255,.65)",fontWeight:500,margin:"0.7rem 0 1.2rem"}}>Continue à relever les défis du jour pour grimper encore.</div>
  ...
  const audioPanel = showAudio && (
    <div className="overlay-dark" style={{zIndex:96}} onClick={()=>{setShowAudio(false);sfx("tap");}}>
      <div className="sheet-glass ashu" style={{maxWidth:"360px"}} onClick={e=>e.stopPropagation()}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"1.1rem"}}>
          <div style={{fontWeight:800,fontSize:"1.25rem",color:"#fff",letterSpacing:"-.02em"}}>🎵 Audio</div>
          <button onClick={()=>{setShowAudio(false);sfx("tap");}}
            style={{padding:"6px 14px",fontSize:".85rem",borderRadius:"10px",background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.2)",color:"#fff",fontWeight:700,cursor:"pointer"}}>Fermer</button>
        </div>

        {/* Toggles */}
        <div style={{display:"flex",flexDirection:"column",gap:".6rem",marginBottom:"1.2rem"}}>
          <button onClick={()=>{const v=!sfxOn;setSfxOn(v);if(v){AudioEngine.setSfxOn(true);AudioEngine.playSfx("correct");}}}
            style={{cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",padding:".75rem .85rem",borderRadius:"12px",background:"rgba(255,255,255,.06)",border:"1.5px solid rgba(255,255,255,.12)"}}>
            <span style={{display:"flex",alignItems:"center",gap:".7rem",fontWeight:700,fontSize:".9rem",color:"#fff"}}>
              <span style={{fontSize:"1.2rem"}}>🔔</span> Effets sonores
            </span>
            <span style={{fontWeight:800,fontSize:".82rem",color:sfxOn?"#32D74B":"rgba(255,255,255,.5)"}}>{sfxOn?"Activés":"Coupés"}</span>
          </button>
          <button onClick={()=>{const v=!musicOn;setMusicOn(v);startAudio();}}
            style={{cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",padding:".75rem .85rem",borderRadius:"12px",background:"rgba(255,255,255,.06)",border:"1.5px solid rgba(255,255,255,.12)"}}>
            <span style={{display:"flex",alignItems:"center",gap:".7rem",fontWeight:700,fontSize:".9rem",color:"#fff"}}>
              <span style={{fontSize:"1.2rem"}}>🎶</span> Musique de fond
            </span>
            <span style={{fontWeight:800,fontSize:".82rem",color:musicOn?"#32D74B":"rgba(255,255,255,.5)"}}>{musicOn?"Activée":"Coupée"}</span>
          </button>
        </div>

        {/* Sélecteur de musique */}
        <div style={{fontSize:".7rem",fontWeight:800,color:"rgba(255,255,255,.5)",letterSpacing:".1em",textTransform:"uppercase",marginBottom:".5rem"}}>Ambiance musicale</div>
          ...
          {AudioEngine.tracks.map(tr=>{
            ...
            return(
              <button key={tr.id}
                ...
                style={{padding:".8rem .5rem",borderRadius:"12px",display:"flex",flexDirection:"column",alignItems:"center",gap:".25rem",cursor:"pointer",
                  background:active?"linear-gradient(145deg,#0066FF,#3B9EFF)":"rgba(255,255,255,.06)",
                  border:`1.5px solid ${active?"#3B9EFF":"rgba(255,255,255,.12)"}`,
                  color:"#fff",boxShadow:active?"0 4px 16px rgba(0,102,255,.4)":"none"}}>
        ...
        <div style={{fontSize:".68rem",color:"rgba(255,255,255,.45)",fontWeight:500,marginTop:"1rem",textAlign:"center",lineHeight:1.4}}>
  ...
  /* Écran de règles (avant de lancer un mode) */
  /* Popup défis du jour */
  /* Panneau Profil : pseudo, avatar, amis */
  const AVATARS = ["🌍","🦊","🐼","🦁","🐸","🦄","🐲","👑","🚀","⚡","🔥","💎","🎯","🏆","🧠","😎"];
  const profilePanel = showProfile && (
    <div className="overlay-dark" style={{zIndex:98}} onClick={()=>{setShowProfile(false);setAddFriendMsg("");sfx("tap");}}>
      <div className="sheet-glass ashu" style={{maxWidth:"370px"}} onClick={e=>e.stopPropagation()}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"1rem"}}>
          <div style={{fontWeight:800,fontSize:"1.25rem",color:"#fff"}}>Mon profil</div>
          <button onClick={()=>{setShowProfile(false);setAddFriendMsg("");sfx("tap");}}
            style={{padding:"6px 14px",fontSize:".85rem",borderRadius:"10px",background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.2)",color:"#fff",fontWeight:700,cursor:"pointer"}}>Fermer</button>
        </div>

        {/* Pseudo */}
        <div style={{fontSize:".7rem",fontWeight:800,color:"rgba(255,255,255,.5)",letterSpacing:".08em",textTransform:"uppercase",marginBottom:".4rem"}}>Pseudo</div>
        <input value={profile?.pseudo||""} maxLength={18}
          onChange={e=>setProfile(p=>({...p,pseudo:e.target.value}))}
          onBlur={()=>updateProfile({pseudo:profile?.pseudo})}
          className="gp-input" style={{height:"48px",marginBottom:"1rem"}}/>

        {/* Avatar */}
        <div style={{fontSize:".7rem",fontWeight:800,color:"rgba(255,255,255,.5)",letterSpacing:".08em",textTransform:"uppercase",marginBottom:".4rem"}}>Avatar</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(8,1fr)",gap:".35rem",marginBottom:"1.1rem"}}>
          {AVATARS.map(a=>(
            <button key={a} onClick={()=>{setProfile(p=>({...p,avatar:a}));updateProfile({avatar:a});sfx("tap");}}
              style={{aspectRatio:"1",borderRadius:"9px",fontSize:"1.2rem",cursor:"pointer",
                background:profile?.avatar===a?"linear-gradient(145deg,#0066FF,#3B9EFF)":"rgba(255,255,255,.07)",
                border:`1.5px solid ${profile?.avatar===a?"#3B9EFF":"rgba(255,255,255,.12)"}`}}>{a}</button>
          ))}
        </div>

        {/* Code ami */}
        <div style={{background:"rgba(255,255,255,.06)",border:"1.5px solid rgba(255,255,255,.12)",borderRadius:"13px",padding:".8rem",marginBottom:".8rem"}}>
          <div style={{fontSize:".7rem",fontWeight:800,color:"rgba(255,255,255,.5)",letterSpacing:".08em",textTransform:"uppercase",marginBottom:".3rem"}}>Ton code ami</div>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
            <span style={{fontWeight:800,fontSize:"1.4rem",color:"#FFD60A",letterSpacing:".15em"}}>{profile?.friend_code||"------"}</span>
            <button onClick={()=>{try{navigator.clipboard.writeText(profile?.friend_code||"")}catch{};sfx("tap");}}
              style={{padding:"6px 12px",fontSize:".78rem",borderRadius:"8px",background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.2)",color:"#fff",fontWeight:700,cursor:"pointer"}}>Copier</button>
          </div>
          <div style={{fontSize:".68rem",color:"rgba(255,255,255,.45)",marginTop:".4rem",fontWeight:500}}>Partage ce code pour que tes amis t'ajoutent.</div>
        </div>

        {/* Ajouter un ami */}
        <div style={{fontSize:".7rem",fontWeight:800,color:"rgba(255,255,255,.5)",letterSpacing:".08em",textTransform:"uppercase",marginBottom:".4rem"}}>Ajouter un ami</div>
        <div style={{display:"flex",gap:".5rem"}}>
          <input value={addFriendCode} maxLength={6}
            onChange={e=>setAddFriendCode(e.target.value.toUpperCase())}
            placeholder="CODE"
            className="gp-input" style={{height:"48px",flex:1,letterSpacing:".1em",textTransform:"uppercase"}}/>
          <button onClick={async()=>{
              const res=await addFriend(addFriendCode);
              setAddFriendMsg(res==="ok"?"✅ Ami ajouté !":res==="introuvable"?"❌ Code introuvable":res==="soi-meme"?"😅 C'est toi !":"Erreur");
              if(res==="ok"){setAddFriendCode("");sfx("correct");}else sfx("wrong");
            }}
            style={{flex:"0 0 auto",padding:"0 20px",height:"48px",borderRadius:"12px",border:"none",cursor:"pointer",fontWeight:800,color:"#fff",background:"linear-gradient(135deg,#0066FF,#3B9EFF)"}}>Ajouter</button>
        </div>
        {addFriendMsg&&<div style={{fontSize:".8rem",color:"rgba(255,255,255,.8)",marginTop:".5rem",textAlign:"center",fontWeight:600}}>{addFriendMsg}</div>}
      </div>
    </div>
  );

  const chalsPanel = showChals && (
    <div className="overlay-dark" style={{zIndex:96}} onClick={()=>{setShowChals(false);sfx("tap");}}>
      <div className="sheet-glass ashu" style={{maxWidth:"380px"}} onClick={e=>e.stopPropagation()}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:".9rem"}}>
          <div style={{fontWeight:800,fontSize:"1.25rem",color:"#fff",letterSpacing:"-.02em"}}>Ma progression</div>
          <button onClick={()=>{setShowChals(false);sfx("tap");}}
            style={{padding:"6px 14px",fontSize:".85rem",borderRadius:"10px",background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.2)",color:"#fff",fontWeight:700,cursor:"pointer"}}>Fermer</button>
        </div>

        {/* Niveau + XP */}
        <div style={{display:"flex",alignItems:"center",gap:".7rem",background:"rgba(255,255,255,.06)",border:"1.5px solid rgba(255,255,255,.12)",borderRadius:"14px",padding:".8rem",marginBottom:"1rem"}}>
          <div style={{width:"42px",height:"42px",borderRadius:"10px",background:"linear-gradient(145deg,#32D74B,#28a83c)",display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800,color:"#fff",fontSize:"1.2rem",boxShadow:"0 3px 0 #1e8a30",flexShrink:0}}>{level}</div>
          <div style={{flex:1}}>
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:".3rem"}}>
              <span style={{fontWeight:800,fontSize:".85rem",color:"#fff"}}>Niveau {level}</span>
              <span style={{fontSize:".7rem",color:"rgba(255,255,255,.5)",fontWeight:600}}>{fmtN(xp-lvlBase)}/{fmtN(lvlNext-lvlBase)} XP</span>
            </div>
        ...
        <div style={{display:"flex",alignItems:"center",gap:".4rem",marginBottom:".6rem"}}>
          ...
          <span style={{fontWeight:800,fontSize:".92rem",color:"#fff"}}>Défis du jour</span>
          <span style={{fontSize:".74rem",color:chalDone.length===4?"#32D74B":"rgba(255,255,255,.5)",fontWeight:700,marginLeft:"auto"}}>{chalDone.length}/4</span>
        </div>
        <div style={{display:"flex",flexDirection:"column",gap:".5rem"}}>
          {todaysChals.map(ch=>{
            const done=chalDone.includes(ch.id);
            return(
              <div key={ch.id} style={{display:"flex",alignItems:"center",gap:".7rem",padding:".7rem .8rem",borderRadius:"12px",
                background:done?"rgba(50,215,75,.14)":"rgba(255,255,255,.05)",border:`1.5px solid ${done?"rgba(50,215,75,.3)":"rgba(255,255,255,.1)"}`}}>
                <div style={{width:"30px",height:"30px",borderRadius:"8px",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",fontSize:".9rem",
                  background:done?"#32D74B":"rgba(255,255,255,.1)",color:"#fff",fontWeight:800}}>{done?"✓":ch.icon}</div>
                <div style={{flex:1,minWidth:0}}>
                  <div style={{fontWeight:700,fontSize:".82rem",color:done?"rgba(255,255,255,.55)":"#fff",textDecoration:done?"line-through":"none",lineHeight:1.25}}>{ch.t}</div>
                </div>
                <div style={{fontSize:".72rem",fontWeight:800,color:done?"#32D74B":"rgba(255,255,255,.5)",flexShrink:0,whiteSpace:"nowrap"}}>+{ch.xp} XP</div>
              </div>
            );
          })}
        </div>
        <div style={{fontSize:".68rem",color:"rgba(255,255,255,.45)",fontWeight:500,marginTop:"1rem",textAlign:"center"}}>
  ...
  const rulesOverlay = rulesMode && RULES[rulesMode] && (() => {
    const r = RULES[rulesMode];
    const pages = r.pages;
    const n = pages.length;
    const isLast = rulesPage >= n-1;
    const goNext = () => { if(rulesPage<n-1){ setRulesPage(p=>p+1); sfx("tap"); } };
    const goPrev = () => { if(rulesPage>0){ setRulesPage(p=>p-1); sfx("tap"); } };
    return (
      <div style={{position:"fixed",inset:0,zIndex:97,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        <AnimatedBG mode={rulesMode}/>
        {/* voile sombre léger pour le contraste */}
        <div style={{position:"absolute",inset:0,background:"rgba(6,10,20,.55)",zIndex:0}}/>

        <div style={{position:"relative",zIndex:1,display:"flex",flexDirection:"column",height:"100%",maxWidth:"440px",width:"100%",margin:"0 auto",padding:"1rem 1.3rem"}}>

          {/* Barre du haut : titre + Passer */}
          <div className="afu" style={{display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:".5rem"}}>
            <div style={{display:"flex",alignItems:"center",gap:".5rem"}}>
              <div style={{width:"30px",height:"30px",borderRadius:"8px",background:r.color,display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.05rem",boxShadow:`0 2px 0 ${r.color}99`}}>{r.icon}</div>
              <span style={{fontWeight:800,fontSize:"1rem",color:"#fff"}}>{r.title}</span>
            </div>
            <button onClick={()=>launchFromRules(false)}
              style={{background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.2)",backdropFilter:"blur(8px)",borderRadius:"var(--r2)",color:"#fff",fontWeight:700,fontSize:".82rem",padding:".5rem .9rem",cursor:"pointer",display:"flex",alignItems:"center",gap:".3rem"}}>
              Passer ⏭
            </button>
          </div>
          ...
          <div style={{flex:1,display:"flex",alignItems:"center",overflow:"hidden",position:"relative"}}
            onTouchStart={e=>{ rulesTouch.current=e.touches[0].clientX; }}
            onTouchEnd={e=>{
              const dx=e.changedTouches[0].clientX-(rulesTouch.current||0);
              if(dx<-45) goNext(); else if(dx>45) goPrev();
            }}>
            <div style={{display:"flex",width:"100%",transition:"transform .32s cubic-bezier(.4,0,.2,1)",transform:`translateX(-${rulesPage*100}%)`}}>
              {pages.map((pg,i)=>(
                <div key={i} style={{minWidth:"100%",padding:"1rem .5rem",textAlign:"center",boxSizing:"border-box"}}>
                  {/* Grande icône */}
                  <div style={{width:"110px",height:"110px",margin:"0 auto 1.6rem",borderRadius:"28px",
                    background:pg.warn?"linear-gradient(145deg,#FFB340,#FF9F0A)":`linear-gradient(145deg,${r.color},${r.color}cc)`,
                    display:"flex",alignItems:"center",justifyContent:"center",fontSize:"3.4rem",
                    boxShadow:`0 12px 40px ${pg.warn?"rgba(255,159,10,.5)":r.color+"77"}`}}>{pg.emoji}</div>
                  <div style={{fontWeight:800,fontSize:"1.5rem",color:"#fff",letterSpacing:"-.02em",marginBottom:".7rem",lineHeight:1.15,textShadow:"0 2px 16px rgba(0,0,0,.4)"}}>{pg.h}</div>
                  <div style={{fontSize:"1rem",color:"rgba(255,255,255,.82)",fontWeight:500,lineHeight:1.55,maxWidth:"340px",margin:"0 auto"}}>{pg.p}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Indicateurs (points) */}
          <div style={{display:"flex",justifyContent:"center",gap:".4rem",padding:".4rem 0 1.2rem"}}>
            {pages.map((_,i)=>(
              <div key={i} onClick={()=>{setRulesPage(i);sfx("tap");}} style={{cursor:"pointer",
                width:i===rulesPage?"24px":"8px",height:"8px",borderRadius:"4px",
                background:i===rulesPage?"#fff":"rgba(255,255,255,.3)",transition:"all .25s"}}/>
            ))}
          </div>
          ...
          <div style={{paddingBottom:"1.4rem"}}>
            {!isLast ? (
              <div style={{display:"flex",gap:".6rem"}}>
                <button className="btn" style={{flex:"0 0 auto",padding:"15px 20px",fontSize:".95rem",background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.22)",color:"#fff",backdropFilter:"blur(8px)",opacity:rulesPage===0?.4:1}}
                  disabled={rulesPage===0} onClick={goPrev}>←</button>
                <button className="btn" style={{flex:1,padding:"15px",fontSize:"1.05rem",fontWeight:800,background:"#fff",color:r.color,boxShadow:"0 4px 0 rgba(0,0,0,.2)"}}
                  onClick={goNext}>Suivant →</button>
              </div>
            ) : (
              <>
                <button className="btn" style={{width:"100%",padding:"17px",fontSize:"1.15rem",fontWeight:800,background:"#fff",color:r.color,boxShadow:"0 5px 0 rgba(0,0,0,.2)"}}
                  onClick={()=>launchFromRules(false)}>▶ Jouer</button>
                <button onClick={()=>launchFromRules(true)}
                  style={{width:"100%",background:"none",border:"none",color:"rgba(255,255,255,.6)",fontWeight:600,fontSize:".82rem",padding:".9rem",marginTop:".2rem",cursor:"pointer"}}>
                  Ne plus afficher les règles de ce mode
                </button>
              </>
            )}
          </div>
  ...
  /* ═══════════════════════════════════════════════════════
     ÉCRAN D'ACCUEIL (splash plein écran)
  ═══════════════════════════════════════════════════════ */
  if(scr==="home") return(
    <div style={{height:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"2rem 1.5rem",position:"relative",zIndex:1,overflow:"hidden"}}>
      <style>{CSS}</style>
      {audioPanel}
      <AnimatedBG mode="menu"/>

      {/* Bouton audio flottant */}
      <button onClick={()=>{startAudio();setShowAudio(true);}}
      ...
      <div className="afu" style={{textAlign:"center",display:"flex",flexDirection:"column",alignItems:"center"}}>
        {/* Icône */}
        <div style={{width:"96px",height:"96px",margin:"0 auto 1.6rem",borderRadius:"26px",
          background:"linear-gradient(145deg,#0066FF,#3B9EFF)",display:"flex",alignItems:"center",justifyContent:"center",
          boxShadow:"0 10px 40px rgba(0,102,255,.5),inset 0 2px 2px rgba(255,255,255,.4)"}}>
          <span style={{fontSize:"3rem",filter:"drop-shadow(0 2px 4px rgba(0,0,0,.25))"}}>🌍</span>
        </div>

        {/* Titre énorme */}
        <div style={{fontSize:".72rem",fontWeight:800,letterSpacing:".2em",color:"rgba(255,255,255,.55)",marginBottom:".6rem",textTransform:"uppercase"}}>Jeu de culture générale</div>
        <h1 style={{fontWeight:800,fontSize:"clamp(3.2rem,16vw,6rem)",letterSpacing:"-.05em",lineHeight:.85,color:"#fff",textShadow:"0 4px 30px rgba(0,0,0,.5)",margin:0}}>
          NATION<br/><span style={{color:"#5AC8FA"}}>RUSH</span>
        </h1>

        {/* Stats rapides */}
        <div style={{display:"flex",gap:"1.5rem",margin:"1.8rem 0 2.4rem",color:"rgba(255,255,255,.6)",fontSize:".8rem",fontWeight:600}}>
          <span>{WORLD.length+FRANCE.length} lieux</span>
          <span style={{color:"rgba(255,255,255,.3)"}}>·</span>
          <span>{RANKINGS.length} classements</span>
          <span style={{color:"rgba(255,255,255,.3)"}}>·</span>
          <span>4 modes</span>
        </div>

        {/* Bouton Jouer */}
        <button className="btn btn-blue" style={{padding:"19px 64px",fontSize:"1.3rem",borderRadius:"50px",fontWeight:800,letterSpacing:".01em"}}
          onClick={()=>{startAudio();sfx("click");setScrn("menu");}}>
          ▶ JOUER
        </button>

        {/* Reprendre si partie en cours */}
        {canResume&&q.length>0&&(
          <button className="btn btn-ghost" style={{marginTop:"1rem",padding:"12px 28px",fontSize:".9rem"}}
            onClick={()=>{startAudio();setScrn("playing");setPaused(false);setTimeout(()=>inpRef.current?.focus(),200);}}>
            ↩ Reprendre ma partie
          </button>
        )}
      </div>
      ...
      <div style={{position:"absolute",bottom:"1.5rem",textAlign:"center"}}>
        <div style={{fontSize:".62rem",color:"rgba(255,255,255,.35)",fontWeight:600,letterSpacing:".04em"}}>NATION RUSH · v2.0</div>
      </div>
    </div>
  );

  /* ═══════════════════════════════════════════════════════
     CLASSEMENT (mondial + amis)
  ═══════════════════════════════════════════════════════ */
  if(scr==="leaderboard") return(
    <div style={{height:"100vh",display:"flex",flexDirection:"column",padding:"1rem 1.1rem",maxWidth:"480px",margin:"0 auto",position:"relative",zIndex:1,overflow:"hidden"}}>
      <style>{CSS}</style>
      <AnimatedBG mode={lbMode}/>

      {/* Header */}
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:".8rem"}}>
        <button onClick={()=>{setScrn("menu");sfx("tap");}}
          style={{padding:"8px 14px",fontSize:".85rem",borderRadius:"11px",background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.2)",backdropFilter:"blur(8px)",color:"#fff",fontWeight:700,cursor:"pointer"}}>← Menu</button>
        <div style={{fontWeight:800,fontSize:"1.15rem",color:"#fff"}}>🏆 Classement</div>
        <button onClick={()=>{setShowProfile(true);sfx("tap");}}
          style={{width:"40px",height:"40px",borderRadius:"11px",background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.2)",backdropFilter:"blur(8px)",color:"#fff",fontSize:"1.1rem",cursor:"pointer"}}>
          {profile?.avatar||"👤"}
        </button>
      </div>

      {/* Onglets Mondial / Amis */}
      <div style={{display:"flex",gap:".5rem",marginBottom:".7rem"}}>
        {[["world","🌍 Mondial"],["friends","👥 Amis"]].map(([t,lbl])=>(
          <button key={t} onClick={()=>{setLbTab(t);loadLeaderboard(lbMode,t);sfx("tap");}}
            style={{flex:1,padding:".6rem",borderRadius:"12px",fontWeight:800,fontSize:".85rem",cursor:"pointer",
              background:lbTab===t?"linear-gradient(135deg,#0066FF,#3B9EFF)":"rgba(255,255,255,.08)",
              border:`1.5px solid ${lbTab===t?"#3B9EFF":"rgba(255,255,255,.14)"}`,color:"#fff"}}>{lbl}</button>
        ))}
      </div>

      {/* Sélecteur de mode */}
      <div style={{display:"flex",gap:".4rem",marginBottom:".7rem",overflowX:"auto",paddingBottom:".2rem"}}>
        {[["world","🌍"],["rankings","🏆"],["highlow","⬆️"],["france","🇫🇷"]].map(([m,ic])=>(
          <button key={m} onClick={()=>{setLbMode(m);loadLeaderboard(m,lbTab);sfx("tap");}}
            style={{flexShrink:0,padding:".45rem .8rem",borderRadius:"10px",fontWeight:700,fontSize:".8rem",cursor:"pointer",
              background:lbMode===m?"rgba(255,255,255,.18)":"rgba(255,255,255,.06)",
              border:`1.5px solid ${lbMode===m?"rgba(255,255,255,.4)":"rgba(255,255,255,.12)"}`,color:"#fff"}}>
            {ic} {m==="world"?"Pays":m==="rankings"?"Top 10":m==="highlow"?"+/-":"France"}
          </button>
        ))}
      </div>
      ...
      {/* Mon rang (mondial) */}
      {lbTab==="world"&&lbRank&&(
        <div className="gp-sm" style={{padding:".6rem .9rem",marginBottom:".6rem",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <span style={{fontSize:".8rem",color:"rgba(255,255,255,.7)",fontWeight:600}}>Ton rang mondial</span>
          <span style={{fontWeight:800,fontSize:"1.1rem",color:"#FFD60A"}}>#{lbRank}</span>
        </div>
      )}

      {/* Liste */}
      <div style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column",gap:".4rem",minHeight:0}}>
        {lbLoading?(
          <div style={{textAlign:"center",color:"rgba(255,255,255,.6)",padding:"2rem",fontWeight:600}}>Chargement…</div>
        ):lbRows.length===0?(
          <div style={{textAlign:"center",color:"rgba(255,255,255,.5)",padding:"2rem 1rem",fontWeight:500,lineHeight:1.5}}>
            {lbTab==="friends"?"Aucun ami pour l'instant.\nAjoute des amis avec leur code via 👤":"Aucun score pour ce mode.\nSois le premier à jouer !"}
          </div>
        ):lbRows.map(row=>{
          const medal=row.rang===1?"🥇":row.rang===2?"🥈":row.rang===3?"🥉":null;
          const me=row.is_me||(profile&&row.user_id===profile.id);
          return(
            <div key={row.user_id} style={{display:"flex",alignItems:"center",gap:".7rem",padding:".6rem .85rem",borderRadius:"12px",
              background:me?"linear-gradient(145deg,rgba(0,102,255,.3),rgba(0,102,255,.1))":"rgba(255,255,255,.06)",
              border:`1.5px solid ${me?"#3B9EFF":"rgba(255,255,255,.1)"}`,backdropFilter:"blur(10px)"}}>
              <div style={{width:"34px",textAlign:"center",fontWeight:800,fontSize:medal?"1.3rem":"1rem",color:row.rang<=3?"#FFD60A":"rgba(255,255,255,.6)",flexShrink:0}}>
                {medal||row.rang}
              </div>
              <span style={{fontSize:"1.3rem",flexShrink:0}}>{row.avatar||"🌍"}</span>
              <span style={{flex:1,fontWeight:700,fontSize:".9rem",color:"#fff",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>
                {row.pseudo}{me&&<span style={{color:"#5AC8FA",fontSize:".72rem",marginLeft:".4rem"}}>(toi)</span>}
              </span>
              <span className="score-num" style={{fontWeight:800,fontSize:"1rem",color:"#fff",flexShrink:0}}>{fmtN(row.best_score)}</span>
            </div>
          );
        })}
      </div>
  ...
  if(scr==="menu") return(
    <div style={{height:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"1rem 1.1rem",position:"relative",zIndex:1,overflow:"auto"}}>
      <style>{CSS}</style>
      {xpOverlay}
      {audioPanel}
      {chalsPanel}
      ...
      {/* Barre du haut : retour + niveau + titre + audio */}
      <div className="afu" style={{position:"absolute",top:"0",left:"0",right:"0",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 14px",zIndex:50}}>
        <div style={{display:"flex",gap:".5rem"}}>
          <button onClick={()=>{setScrn("home");sfx("tap");}}
            style={{width:"40px",height:"40px",borderRadius:"var(--r2)",background:"rgba(255,255,255,.1)",border:"1.5px solid rgba(255,255,255,.2)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.1rem",color:"#fff"}}
            aria-label="Accueil">←</button>
          {/* Badge niveau + défis (cliquable) */}
          <button onClick={()=>{setShowChals(true);sfx("tap");}}
            style={{height:"40px",borderRadius:"var(--r2)",background:"rgba(255,255,255,.1)",border:"1.5px solid rgba(255,255,255,.2)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",gap:".4rem",padding:"0 .7rem 0 .35rem",color:"#fff",cursor:"pointer"}}
            aria-label="Progression">
            <span style={{width:"28px",height:"28px",borderRadius:"7px",background:"linear-gradient(145deg,#32D74B,#28a83c)",display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800,color:"#fff",fontSize:".8rem",boxShadow:"0 2px 0 #1e8a30"}}>{level}</span>
            <span style={{display:"flex",alignItems:"center",gap:".25rem",fontWeight:800,fontSize:".72rem"}}>
              🎯 <span style={{color:chalDone.length===4?"#32D74B":"#fff"}}>{chalDone.length}/4</span>
            </span>
          </button>
        </div>
        <div style={{display:"flex",gap:".5rem"}}>
          {cloudEnabled()&&<button onClick={()=>{setLbTab("world");setLbMode(gt);loadLeaderboard(gt,"world");setScrn("leaderboard");sfx("tap");}}
            style={{width:"40px",height:"40px",borderRadius:"var(--r2)",background:"rgba(255,255,255,.1)",border:"1.5px solid rgba(255,255,255,.2)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.1rem",color:"#fff"}}
            aria-label="Classement">🏆</button>}
          <button onClick={()=>{startAudio();setShowAudio(true);sfx("tap");}}
            style={{width:"40px",height:"40px",borderRadius:"var(--r2)",background:"rgba(255,255,255,.1)",border:"1.5px solid rgba(255,255,255,.2)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.1rem",color:"#fff"}}
            aria-label="Audio">{musicOn||sfxOn?"🔊":"🔇"}</button>
        </div>
      </div>

      {/* Contenu principal (centré, compact) */}
      <div style={{width:"100%",maxWidth:"410px",display:"flex",flexDirection:"column",gap:".9rem",marginTop:"2.5rem"}}>

      {/* Mode selector compact */}
      <div className="afu" style={{animationDelay:".04s"}}>
        <div style={{display:"flex",alignItems:"center",gap:".4rem",marginBottom:".5rem"}}>
          <span style={{width:"18px",height:"18px",borderRadius:"5px",background:"var(--blue)",color:"#fff",fontWeight:800,fontSize:".66rem",display:"flex",alignItems:"center",justifyContent:"center"}}>1</span>
          <span style={{fontSize:".66rem",fontWeight:800,color:"rgba(255,255,255,.7)",letterSpacing:".08em",textTransform:"uppercase"}}>Choisis un mode</span>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:".6rem"}}>
          {[
            {g:"world",  icon:"🌍",name:"Pays du Monde",  sub:`${WORLD.length} pays`,    col:"#0066FF",g2:"#3B9EFF",hs:hsW},
            {g:"rankings",icon:"🏆",name:"Top 10 Mondial", sub:`${RANKINGS.length} classements`, col:"#FF9F0A",g2:"#FFD60A",hs:hsR},
            {g:"highlow",icon:"⬆️",name:"Plus ou Moins",  sub:`Top 50`, col:"#32D74B",g2:"#5be36a",hs:hsHL},
            {g:"france", icon:"🇫🇷",name:"Villes de France",sub:`${FRANCE.length} villes`, col:"#1B4FBB",g2:"#4F8BFF",hs:hsF},
          ].map(m=>{
            const on=gt===m.g;
            return(
            <div key={m.g} className={`gcard${on?" on":""}`}
              onClick={()=>{setGT(m.g);sfx("tap");}}
              style={on?{borderColor:m.col,boxShadow:`0 0 0 1.5px ${m.col},0 0 22px ${m.col}66,inset 0 1px 1px rgba(255,255,255,.2)`,background:`linear-gradient(145deg,${m.col}33,${m.col}11)`}:undefined}>
              {on&&<div style={{position:"absolute",top:"7px",right:"7px",width:"18px",height:"18px",borderRadius:"6px",background:m.col,color:"#fff",fontSize:".64rem",display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800,boxShadow:`0 0 10px ${m.col}`}}>✓</div>}
              <div style={{display:"flex",alignItems:"center",gap:".55rem"}}>
                <div className="gicon" style={{background:`linear-gradient(145deg,${m.col},${m.g2})`}}>{m.icon}</div>
                <div style={{textAlign:"left",flex:1,minWidth:0}}>
                  <div style={{fontWeight:800,fontSize:".82rem",color:"#fff",lineHeight:1.1,letterSpacing:"-.01em"}}>{m.name}</div>
                  <div style={{fontSize:".64rem",fontWeight:600,color:"rgba(255,255,255,.55)",marginTop:".12rem"}}>
                    {m.hs>0?`🏆 ${fmtN(m.hs)}`:m.sub}
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Étape 2 : lancer */}
      <div className="afu" style={{animationDelay:".06s",display:"flex",alignItems:"center",gap:".4rem",marginTop:".2rem"}}>
        <span style={{width:"18px",height:"18px",borderRadius:"5px",background:"var(--green)",color:"#fff",fontWeight:800,fontSize:".66rem",display:"flex",alignItems:"center",justifyContent:"center"}}>2</span>
        <span style={{fontSize:".66rem",fontWeight:800,color:"rgba(255,255,255,.7)",letterSpacing:".08em",textTransform:"uppercase"}}>Lance la partie</span>
      </div>

      {/* Quick actions — bouton Jouer futuriste identique pour tous les modes */}
      <div className="afu" style={{animationDelay:".08s",display:"flex",flexDirection:"column",alignItems:"center",gap:".55rem"}}>
        <button className="gplay" style={{padding:"17px",fontSize:"1.25rem",fontWeight:800,color:"#fff",letterSpacing:".01em"}}
          onClick={()=>{
            if(gt==="rankings") openRules("rankings");
            else if(gt==="highlow") openRules("highlow");
            else openRules(gt,{...NORMAL_PRESET,diff:[1,2,3,4],region:"all"});
          }}>
          <span style={{position:"relative",zIndex:1,textShadow:"0 1px 8px rgba(0,0,0,.3)"}}>▶ JOUER</span>
        </button>
        {/* Zone variantes — hauteur réservée pour éviter que le menu saute */}
        <div style={{width:"100%",minHeight:"46px",display:"flex",alignItems:"center"}}>
          {(gt==="world"||gt==="france")?(
            <div style={{display:"flex",gap:".5rem",width:"100%"}}>
              {PRESETS.map(p=>(
                <button key={p.id} className="gpill" onClick={()=>openRules(gt,{...p,diff:[1,2,3,4],region:"all"})}
                  style={{flex:1,padding:".6rem",boxShadow:`inset 0 0 0 1px ${p.col}30`}}>
                  <span style={{fontSize:"1rem"}}>{p.icon}</span>
                  <span style={{fontWeight:800,fontSize:".78rem",color:p.col}}>{p.name}</span>
                </button>
              ))}
              <button className="gpill" onClick={()=>setScrn("custom")}
                style={{padding:".6rem .8rem"}}>
                <span style={{fontSize:"1rem"}}>⚙️</span>
              </button>
            </div>
          ):(
            <div style={{width:"100%",textAlign:"center",fontSize:".72rem",color:"rgba(255,255,255,.4)",fontWeight:500}}>
              {gt==="rankings"?"3 manches · 3 vies · Top 10 réels":"Combo illimité · 3 vies"}
            </div>
          )}
        </div>
      </div>
  ...
  if(scr==="hl_play"&&hlCat&&hlLeft&&hlRight){
    ...
    const rankBadge=(rank,col)=>(
      <div style={{display:"inline-flex",alignItems:"center",gap:".4rem",background:`${col}28`,border:`1.5px solid ${col}`,borderRadius:"12px",padding:".35rem .9rem"}}>
        <span style={{fontWeight:800,fontSize:"1.4rem",color:col,letterSpacing:"-.02em"}}>
          {rank===1?"🥇":rank===2?"🥈":rank===3?"🥉":`#${rank}`}
        </span>
        <span style={{fontSize:".72rem",color:"rgba(255,255,255,.6)",fontWeight:600}}>sur {total}</span>
      </div>
    );
    return(
      <div style={{height:"100vh",display:"flex",flexDirection:"column",padding:".9rem 1.1rem",maxWidth:"480px",margin:"0 auto",gap:".6rem",position:"relative",zIndex:1,overflow:"hidden"}}>
        <style>{CSS}</style>
        {xpOverlay}
        ...
        {/* Header */}
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <button onClick={()=>setScrn("menu")}
            style={{padding:"8px 13px",fontSize:".82rem",borderRadius:"11px",background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.2)",backdropFilter:"blur(8px)",color:"#fff",fontWeight:700,cursor:"pointer"}}>← Menu</button>
          <div style={{textAlign:"center",position:"relative"}}>
            <div style={{fontSize:".55rem",fontWeight:700,color:"rgba(255,255,255,.5)",letterSpacing:".12em",textTransform:"uppercase"}}>SCORE</div>
            <div className="score-num" style={{fontWeight:800,fontSize:"1.7rem",letterSpacing:"-.04em",color:"#fff",lineHeight:1}}>{hlScore}</div>
          </div>
          <div style={{display:"flex",gap:".45rem",alignItems:"center"}}>
            {hlCombo>=2&&<div className="gp-sm abadge" style={{padding:".25rem .55rem",textAlign:"center"}}>
              <div style={{fontSize:".5rem",fontWeight:700,color:"rgba(255,255,255,.5)",letterSpacing:".1em"}}>SÉRIE</div>
            ...
            <div style={{fontSize:"1rem"}}>{[...Array(3)].map((_,i)=><span key={i}>{i<hlLives?"❤️":"🤍"}</span>)}</div>
          </div>
        </div>

        {/* Category banner */}
        <div className="gp-sm" style={{padding:".6rem 1rem",textAlign:"center"}}>
          <div style={{fontSize:".6rem",fontWeight:700,color:"rgba(255,255,255,.5)",letterSpacing:".1em",textTransform:"uppercase",marginBottom:".12rem"}}>Classement</div>
          <div style={{fontWeight:800,fontSize:"1rem",color:"#fff",letterSpacing:"-.01em"}}>
            <span style={{marginRight:".4rem"}}>{hlCat.e}</span>{hlCat.lb}
          </div>
        </div>

        {/* Cartes pays */}
        <div style={{flex:1,display:"flex",flexDirection:"column",gap:".5rem",justifyContent:"center",minHeight:0}}>
          {/* GAUCHE — pays connu avec son rang */}
          <div className="gp" style={{padding:"1.1rem",textAlign:"center",background:"linear-gradient(135deg,rgba(50,215,75,.18),rgba(255,255,255,.04))",border:"1.5px solid rgba(50,215,75,.35)"}}>
            <div style={{fontSize:"2.6rem",lineHeight:1,marginBottom:".3rem"}}>{hlLeft.f}</div>
            <div style={{fontWeight:800,fontSize:"1.25rem",letterSpacing:"-.02em",color:"#fff",marginBottom:".45rem"}}>{hlLeft.nm}</div>
          ...
          <div style={{display:"flex",alignItems:"center",gap:".7rem",padding:"0 .5rem"}}>
            ...
            <div style={{fontWeight:800,fontSize:".85rem",color:"rgba(255,255,255,.6)",letterSpacing:".05em"}}>VS</div>
            <div style={{flex:1,height:"1px",background:"rgba(255,255,255,.2)"}}/>
          </div>

          {/* DROITE — pays à deviner */}
          <div className="gp" style={{padding:"1.1rem",textAlign:"center",position:"relative",
            border:showVal?(hlResult?"2px solid #32D74B":"2px solid #FF3B30"):"1.5px solid rgba(255,255,255,.15)",
            transition:"border-color .3s"}}>
            <div style={{fontSize:"2.6rem",lineHeight:1,marginBottom:".3rem"}}>{hlRight.f}</div>
            <div style={{fontWeight:800,fontSize:"1.25rem",letterSpacing:"-.02em",color:"#fff",marginBottom:".45rem"}}>{hlRight.nm}</div>
            {showVal?(
              <div className="asp">
                {rankBadge(hlRight.rank,hlResult?"#32D74B":"#FF3B30")}
                <div style={{fontSize:".82rem",fontWeight:700,marginTop:".5rem",color:hlResult?"#32D74B":"#FF6961"}}>
                  {hlResult?"✓ Bien vu !":"✗ Raté"}
                  {" · "}{rightBetter?"⬆️ Mieux classé":"⬇️ Moins bien classé"} que {hlLeft.nm}
                </div>
              </div>
            ):(
              <div style={{fontSize:"1.6rem",fontWeight:800,color:"rgba(255,255,255,.35)",letterSpacing:".12em"}}>#?</div>
            )}
          </div>
        </div>
        ...
        <div style={{display:"flex",gap:".7rem"}}>
          <button disabled={hlPhase!=="playing"} onClick={()=>hlGuess("lower")}
            style={{flex:1,padding:"15px 12px",borderRadius:"16px",fontSize:".98rem",cursor:"pointer",
              background:hlPick==="lower"?(hlResult?"#32D74B":"#FF3B30"):"linear-gradient(145deg,rgba(255,255,255,.1),rgba(255,255,255,.04))",
              border:`1.5px solid ${hlPick==="lower"?(hlResult?"#32D74B":"#FF3B30"):"rgba(255,255,255,.18)"}`,backdropFilter:"blur(12px)",
              color:"#fff",opacity:hlPhase!=="playing"&&hlPick!=="lower"?.45:1,fontWeight:800,lineHeight:1.2}}>
            ⬇️ Moins bien<br/><span style={{fontSize:".68rem",fontWeight:600,opacity:.8}}>classé</span>
          </button>
          <button disabled={hlPhase!=="playing"} onClick={()=>hlGuess("higher")}
            style={{flex:1,padding:"15px 12px",borderRadius:"16px",fontSize:".98rem",cursor:"pointer",
              background:hlPick==="higher"?(hlResult?"#32D74B":"#FF3B30"):"linear-gradient(145deg,rgba(255,255,255,.1),rgba(255,255,255,.04))",
              border:`1.5px solid ${hlPick==="higher"?(hlResult?"#32D74B":"#FF3B30"):"rgba(255,255,255,.18)"}`,backdropFilter:"blur(12px)",
              color:"#fff",opacity:hlPhase!=="playing"&&hlPick!=="higher"?.45:1,fontWeight:800,lineHeight:1.2}}>
            ⬆️ Mieux<br/><span style={{fontSize:".68rem",fontWeight:600,opacity:.8}}>classé</span>
          </button>
        </div>

        <div style={{textAlign:"center",color:"rgba(255,255,255,.5)",fontSize:".66rem",fontWeight:600}}>
          <span style={{fontWeight:700,color:"rgba(255,255,255,.75)"}}>{hlRight.nm}</span> est-il mieux ou moins bien classé que <span style={{fontWeight:700,color:"rgba(255,255,255,.75)"}}>{hlLeft.nm}</span> ?
        </div>

        {/* Game over */}
        {hlPhase==="over"&&(
          <div className="overlay-dark">
            <div className="sheet-glass ashu" style={{textAlign:"center",maxWidth:"360px"}}>
              <div style={{fontSize:"3rem",marginBottom:".6rem"}}>{hlScore>=hsHL&&hlScore>0?"🏆":hlScore>=15?"🔥":"🎮"}</div>
              <div style={{fontWeight:800,fontSize:"1.6rem",letterSpacing:"-.03em",color:"#fff",marginBottom:".3rem"}}>
                {hlScore>=hsHL&&hlScore>0?"Nouveau record !":"Partie terminée"}
              </div>
              <div style={{fontWeight:600,fontSize:".88rem",color:"rgba(255,255,255,.6)",marginBottom:"1.1rem"}}>⬆️ Plus ou Moins</div>
              <div style={{background:"linear-gradient(135deg,rgba(50,215,75,.18),rgba(48,209,88,.06))",borderRadius:"14px",padding:"1rem",marginBottom:"1rem",border:"1.5px solid rgba(50,215,75,.3)"}}>
                <div style={{fontSize:".6rem",fontWeight:700,color:"rgba(255,255,255,.5)",letterSpacing:".12em",textTransform:"uppercase",marginBottom:".16rem"}}>SÉRIE FINALE</div>
                <div className="score-num" style={{fontWeight:800,fontSize:"3rem",color:"#32D74B",letterSpacing:"-.04em",lineHeight:1}}>{hlScore}</div>
                <div style={{fontSize:".76rem",color:"rgba(255,255,255,.5)",fontWeight:500,marginTop:".3rem"}}>bonnes réponses d'affilée · record {Math.max(hsHL,hlScore)}</div>
              </div>
              <button onClick={()=>doShare("highlow",{score:hlScore})}
                style={{width:"100%",padding:"15px",borderRadius:"15px",border:"none",cursor:"pointer",fontWeight:800,fontSize:"1rem",color:"#fff",marginBottom:".55rem",
                  background:"linear-gradient(135deg,#32D74B,#28a83c)",boxShadow:"0 0 0 1px rgba(255,255,255,.15),0 6px 20px rgba(50,215,75,.5)"}}>
                📲 Partager mon score
              </button>
              {shareMsg&&<div style={{fontSize:".78rem",color:"#32D74B",fontWeight:700,marginBottom:".5rem"}}>{shareMsg}</div>}
              <div style={{display:"flex",gap:".65rem",justifyContent:"center"}}>
                <button className="btn btn-green" onClick={startHL} style={{fontSize:".95rem",padding:"14px 26px",flex:1}}>🔄 Rejouer</button>
                <button onClick={()=>setScrn("menu")} style={{fontSize:".9rem",padding:"14px 20px",borderRadius:"14px",background:"rgba(255,255,255,.1)",border:"1.5px solid rgba(255,255,255,.2)",color:"#fff",fontWeight:700,cursor:"pointer"}}>← Menu</button>
              </div>
            </div>
          </div>
        )}
  ...
  if(scr==="ranking_play"&&rCat){
    ...
    return(
      <div style={{height:"100vh",display:"flex",flexDirection:"column",padding:".8rem 1rem",maxWidth:"490px",margin:"0 auto",gap:".55rem",position:"relative",zIndex:1,overflow:"hidden"}}>
        <style>{CSS}</style>
        {xpOverlay}
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <div style={{display:"flex",alignItems:"center",gap:".4rem"}}>
            <button onClick={()=>setScrn("menu")}
              style={{padding:"8px 13px",fontSize:".82rem",borderRadius:"11px",background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.2)",backdropFilter:"blur(8px)",color:"#fff",fontWeight:700,cursor:"pointer"}}>← Menu</button>
            <div className="gp-sm" style={{padding:".3rem .7rem",fontSize:".74rem",color:"rgba(255,255,255,.7)",fontWeight:600}}>
              Manche <span style={{color:"#fff",fontWeight:800}}>{rRound}</span>/3
            </div>
          </div>
          <div style={{textAlign:"center",position:"relative"}}>
            <div style={{fontSize:".55rem",fontWeight:700,color:"rgba(255,255,255,.5)",letterSpacing:".12em",textTransform:"uppercase"}}>SCORE</div>
            <div className="score-num" style={{fontWeight:800,fontSize:"1.7rem",letterSpacing:"-.04em",color:"#fff",lineHeight:1}}>{fmtN(rScore)}</div>
          ...
          <div style={{fontSize:"1rem"}}>{[...Array(3)].map((_,i)=><span key={i}>{i<rLives?"❤️":"🤍"}</span>)}</div>
        </div>

        {/* Category card */}
        <div className="gp" style={{padding:".75rem .9rem"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:".3rem"}}>
            <span className="diff-badge" style={{background:`${di.c}28`,color:"#fff",border:`1px solid ${di.c}`,fontWeight:700}}>{rankDiff(rCat.d)} {di.l}</span>
            <span style={{fontSize:".66rem",color:"rgba(255,255,255,.5)",fontWeight:500}}>{rCat.s}</span>
          </div>
          <div style={{fontWeight:800,fontSize:"clamp(.95rem,3.4vw,1.2rem)",color:"#fff",letterSpacing:"-.02em",lineHeight:1.2}}>
            <span style={{fontSize:"1.3rem",marginRight:".4rem"}}>{rCat.e}</span>{rCat.lb}
          </div>
          <div style={{marginTop:".5rem",display:"flex",alignItems:"center",gap:".5rem"}}>
            <div style={{flex:1,height:"5px",background:"rgba(255,255,255,.15)",borderRadius:"3px",overflow:"hidden"}}>
            ...
            <span style={{fontSize:".72rem",fontWeight:800,color:"var(--yellow)"}}>{foundCount}/10</span>
          </div>
        </div>

        {/* Top 10 slots — grille 2 colonnes (sans scroll) */}
        <div style={{flex:1,display:"grid",gridTemplateColumns:"1fr 1fr",gridAutoRows:"1fr",gap:".45rem",minHeight:0,alignContent:"stretch"}}>
          {rSlots.map((slot,i)=>{
            const numCol=i===0?"#FFD60A":i===1?"#C0C0C0":i===2?"#CD7F32":"rgba(255,255,255,.6)";
            return(
              <div key={i} className={slot.justRevealed?"asp":""} style={{
                display:"flex",alignItems:"center",gap:".5rem",padding:".35rem .55rem",borderRadius:"12px",
                background:slot.revealed?"linear-gradient(145deg,rgba(50,215,75,.22),rgba(50,215,75,.08))":"rgba(255,255,255,.06)",
                border:`1.5px solid ${slot.revealed?"rgba(50,215,75,.5)":"rgba(255,255,255,.1)"}`,
                backdropFilter:"blur(10px)",transition:"all .3s cubic-bezier(.4,0,.2,1)",minWidth:0}}>
                <div style={{width:"26px",height:"26px",borderRadius:"7px",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",
                  background:slot.revealed?`${numCol}28`:"rgba(255,255,255,.1)",color:numCol,fontWeight:800,fontSize:".78rem"}}>
                  {i===0?"🥇":i===1?"🥈":i===2?"🥉":`${i+1}`}
                </div>
                {slot.revealed?(
                  <div style={{display:"flex",alignItems:"center",gap:"6px",flex:1,minWidth:0}}>
                    <span style={{fontSize:"1.1rem",flexShrink:0}}>{slot.f}</span>
                    <span style={{fontWeight:700,fontSize:".8rem",color:"#fff",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{slot.nm}</span>
                  </div>
                ):(
                  <span style={{color:"rgba(255,255,255,.35)",fontWeight:700,fontSize:".82rem",letterSpacing:".1em"}}>· · · ·</span>
                )}
              </div>
            );
          })}
        ...
        {rWrong.length>0&&(
          <div style={{display:"flex",flexWrap:"wrap",gap:".35rem",justifyContent:"center"}}>
            {rWrong.map((w,i)=>(
              <span key={i} style={{display:"inline-flex",alignItems:"center",gap:"4px",padding:".2rem .55rem",background:"rgba(255,59,48,.2)",border:"1px solid rgba(255,59,48,.4)",borderRadius:"8px",fontSize:".72rem",fontWeight:700,color:"#FF6961"}}>✗ {w.nm}</span>
            ))}
          </div>
        )}
        ...
        {/* Input */}
        {rPhase==="playing"&&(
          <div className={rShake?"ashk":""} style={{position:"relative",flexShrink:0}}>
            <div style={{display:"flex",gap:".5rem",alignItems:"stretch"}}>
              <div style={{flex:"1 1 auto",position:"relative",minWidth:0}}>
                <input ref={rInpRef} value={rGuess} onChange={e=>onRInput(e.target.value)}
                  ...
                  className="gp-input" style={{height:"54px"}}/>
                {rSugg.length>0&&(
              ...
              <button onClick={submitRanking}
                style={{flex:"0 0 64px",width:"64px",height:"54px",borderRadius:"15px",border:"none",cursor:"pointer",fontSize:"1.4rem",color:"#fff",fontWeight:800,background:"linear-gradient(135deg,#FF9F0A,#FFD60A)",boxShadow:"0 0 0 1px rgba(255,255,255,.15),0 6px 20px rgba(255,159,10,.5)"}}>✓</button>
            </div>
          </div>
        )}
        ...
        {rPhase==="game_end"&&(
          <div className="overlay-dark">
            <div className="sheet-glass ashu" style={{textAlign:"center",maxWidth:"360px"}}>
              ...
              <div style={{fontWeight:800,fontSize:"1.6rem",letterSpacing:"-.03em",color:"#fff",marginBottom:".3rem"}}>Partie terminée</div>
              <div style={{fontWeight:600,fontSize:".88rem",color:"rgba(255,255,255,.6)",marginBottom:"1.1rem"}}>🏆 Top 10 Mondial · 3 manches</div>

              <div style={{background:"linear-gradient(135deg,rgba(255,159,10,.18),rgba(255,214,10,.08))",borderRadius:"14px",padding:"1rem",marginBottom:"1rem",border:"1.5px solid rgba(255,159,10,.3)"}}>
                <div style={{fontSize:".6rem",fontWeight:700,color:"rgba(255,255,255,.5)",letterSpacing:".12em",textTransform:"uppercase",marginBottom:".16rem"}}>SCORE FINAL</div>
                <div className="score-num" style={{fontWeight:800,fontSize:"3rem",color:"#FF9F0A",letterSpacing:"-.04em",lineHeight:1}}>{fmtN(rScore)}</div>
                <div style={{fontSize:".76rem",color:"rgba(255,255,255,.5)",fontWeight:500,marginTop:".3rem"}}>sur 69 possibles · record {fmtN(Math.max(hsR,rScore))}</div>
              </div>

              <button onClick={()=>doShare("rankings",{score:rScore,rounds:[{found:Math.round(rScore/3/2)},{found:Math.round(rScore/3/2)},{found:Math.round(rScore/3/2)}]})}
                style={{width:"100%",padding:"15px",borderRadius:"15px",border:"none",cursor:"pointer",fontWeight:800,fontSize:"1rem",color:"#fff",marginBottom:".55rem",
                  background:"linear-gradient(135deg,#FF9F0A,#FFD60A)",boxShadow:"0 0 0 1px rgba(255,255,255,.15),0 6px 20px rgba(255,159,10,.5)"}}>
                📲 Partager mon score
              </button>
              {shareMsg&&<div style={{fontSize:".78rem",color:"#32D74B",fontWeight:700,marginBottom:".5rem"}}>{shareMsg}</div>}
              <div style={{display:"flex",gap:".65rem",justifyContent:"center"}}>
                <button className="btn btn-gold" onClick={startRanking} style={{fontSize:".95rem",padding:"14px 24px",flex:1}}>🔄 Rejouer</button>
                <button onClick={()=>setScrn("menu")} style={{fontSize:".9rem",padding:"14px 20px",borderRadius:"14px",background:"rgba(255,255,255,.1)",border:"1.5px solid rgba(255,255,255,.2)",color:"#fff",fontWeight:700,cursor:"pointer"}}>← Menu</button>
              </div>
            </div>
          </div>
    ...
    return(
      <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",padding:"1rem 1.1rem",maxWidth:"490px",margin:"0 auto",gap:".6rem",position:"relative",zIndex:1}}>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:".3rem 0"}}>
          <div style={{display:"flex",alignItems:"center",gap:".4rem"}}>
            <button onClick={()=>setPaused(true)} aria-label="Menu"
              style={{padding:"7px 12px",fontSize:"1rem",borderRadius:"11px",background:"rgba(255,255,255,.12)",border:"1.5px solid rgba(255,255,255,.2)",backdropFilter:"blur(8px)",color:"#fff",cursor:"pointer"}}>☰</button>
            <div className="gp-sm" style={{padding:".3rem .75rem",fontSize:".76rem",color:"rgba(255,255,255,.7)",fontWeight:600}}>
              <span style={{color:"#fff",fontWeight:800}}>{qi+1}</span>/{q.length}
            </div>
          </div>
          <div style={{textAlign:"center",position:"relative"}}>
          ...
          <div style={{display:"flex",gap:".42rem",alignItems:"center"}}>
            {!!cfg.timer&&<div className="score-num" style={{fontWeight:800,fontSize:"1.6rem",letterSpacing:"-.04em",lineHeight:1,width:"1.8rem",textAlign:"center",color:spT<=2?"var(--red)":"#fff",...(spT<=2?{animation:"blk .5s ease-in-out infinite"}:{})}}>{spT}</div>}
          </div>
        </div>

        {/* Points strip */}
        <div className="gp-sm" style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:".5rem .8rem"}}>
          <div style={{display:"flex",alignItems:"center",gap:".48rem"}}>
            {!isFr&&<span className="chip" style={{background:`${di.c}30`,color:"#fff",border:`1px solid ${di.c}`,fontWeight:700}}>{di.l}</span>}
            {isFr&&<span className="chip" style={{background:"rgba(91,151,255,.25)",color:"#fff",border:"1px solid rgba(91,151,255,.5)",fontWeight:700}}>🇫🇷 France</span>}
            <span style={{fontSize:".77rem",color:"rgba(255,255,255,.55)",fontWeight:500}}>Cet indice :</span>
            <span className="score-num" style={{fontWeight:800,fontSize:".95rem",color:pNow>=8?"#32D74B":pNow>=4?"#FFD60A":"#FF9F0A"}}>{pNow} pt{pNow>1?"s":""}</span>
          </div>
          <div style={{display:"flex",gap:"4px"}}>
            {hints.map((_,i)=>(<div key={i} className="dot" style={{width:i<hi?16:i===hi?11:6,background:i<hi?"rgba(255,255,255,.4)":i===hi?"#fff":"rgba(255,255,255,.15)",boxShadow:i===hi?"0 0 6px rgba(255,255,255,.6)":"none"}}/>))}
          </div>
        </div>
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",gap:".44rem"}}>
          {prevH.map((h,i,arr)=>(
            <div key={`p${i}`} className="gp-sm" style={{padding:".55rem .9rem",display:"flex",alignItems:"center",gap:".58rem"}}>
              <span style={{fontSize:".95rem",flexShrink:0}}>{h.icon}</span>
              <span style={{color:"rgba(255,255,255,.5)",fontSize:".66rem",minWidth:"78px",fontWeight:700,textTransform:"uppercase",letterSpacing:".03em"}}>{h.label}</span>
              <span style={{color:"#fff",fontSize:".88rem",fontWeight:600}}>{h.value}</span>
            </div>
          ))}

          {phase==="playing"&&curH&&(
            <div key={`h${hi}`} className="gp asr" style={{padding:"1.25rem"}}>
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:".72rem"}}>
                <div style={{display:"flex",alignItems:"center",gap:".45rem"}}>
                  <div style={{width:"8px",height:"8px",borderRadius:"50%",background:curH.col,boxShadow:`0 0 8px ${curH.col}`,flexShrink:0}}/>
                  <span style={{fontSize:".63rem",fontWeight:800,letterSpacing:".1em",color:"#fff",textTransform:"uppercase"}}>{curH.label}</span>
                </div>
                <span style={{fontSize:".67rem",color:"rgba(255,255,255,.5)",fontWeight:600}}>#{hi+1}/{hints.length}</span>
              </div>
              {isFlag?<div style={{textAlign:"center",padding:".5rem 0",fontSize:"4.5rem"}}>{curH.value}</div>
                :isScr?<div style={{textAlign:"center",padding:".3rem 0"}}>
                  ...
                  <div style={{color:"rgba(255,255,255,.5)",fontSize:".72rem",marginTop:".55rem",fontWeight:500}}>Remets les lettres dans l'ordre</div>
                </div>
                :<div style={{fontWeight:700,fontSize:"clamp(1.05rem,3.5vw,1.48rem)",color:"#fff",lineHeight:1.38,letterSpacing:"-.01em",wordBreak:"break-word"}}>{curH.value}</div>}
            </div>
          )}

          {phase==="revealed"&&revC&&!sheet&&(
            <div className="gp asp" style={{padding:"1.65rem",textAlign:"center",border:"1.5px solid rgba(255,59,48,.4)"}}>
              <div style={{fontSize:"3rem",marginBottom:".45rem"}}>{isFr?"📍":revC.f}</div>
              <div style={{color:"#FF6961",fontSize:".7rem",fontWeight:800,letterSpacing:".1em",textTransform:"uppercase",marginBottom:".26rem"}}>C'ÉTAIT...</div>
              <div style={{fontWeight:800,fontSize:"1.65rem",letterSpacing:"-.02em",color:"#fff"}}>{revC.nm}</div>
              {isFr&&<div style={{color:"rgba(255,255,255,.6)",fontSize:".82rem",marginTop:".28rem",fontWeight:500}}>{revC.rg}</div>}
              <div style={{color:"rgba(255,255,255,.5)",fontSize:".8rem",marginTop:".42rem",fontWeight:500}}>0 point pour cette manche</div>
            </div>
          )}
        </div>
        ...
        {phase==="playing"&&(
          <div style={{display:"flex",flexDirection:"column",gap:".55rem"}}>
            <div className={shake?"ashk":""} style={{display:"flex",gap:".52rem",alignItems:"stretch"}}>
              <div style={{flex:"1 1 auto",position:"relative",minWidth:0}}>
              ...
              <button onClick={submit}
                style={{flex:"0 0 64px",width:"64px",height:"54px",borderRadius:"15px",border:"none",cursor:"pointer",fontSize:"1.45rem",color:"#fff",fontWeight:800,background:"linear-gradient(135deg,#0066FF,#3B9EFF)",boxShadow:"0 0 0 1px rgba(255,255,255,.15),0 6px 20px rgba(0,102,255,.5)"}}>✓</button>
            </div>

            <button onClick={doSkip}
              style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:"14px",width:"100%",padding:"16px 18px",borderRadius:"16px",cursor:"pointer",
                background:isLast?"linear-gradient(145deg,rgba(255,59,48,.18),rgba(255,59,48,.06))":"linear-gradient(145deg,rgba(255,159,10,.18),rgba(255,159,10,.06))",
                border:`1.5px solid ${isLast?"rgba(255,59,48,.5)":"rgba(255,159,10,.5)"}`,backdropFilter:"blur(14px)",WebkitBackdropFilter:"blur(14px)",
                boxShadow:`0 6px 22px ${isLast?"rgba(255,59,48,.2)":"rgba(255,159,10,.2)"}`}}>
              <div style={{textAlign:"left",flex:1}}>
                <div style={{display:"flex",alignItems:"center",gap:".4rem",marginBottom:".3rem"}}>
                  <span style={{fontSize:".95rem"}}>{isLast?"⚡":"⚠️"}</span>
                  <span style={{fontSize:".68rem",fontWeight:800,letterSpacing:".06em",textTransform:"uppercase",color:isLast?"#FF6961":"#FFB340"}}>
                    {isLast?"Révéler la réponse · 0 point":`Indice suivant · tu perds ${pNow-pNxt} pt${(pNow-pNxt)>1?"s":""}`}
                  </span>
                </div>
                <div style={{fontWeight:800,fontSize:"1.05rem",letterSpacing:"-.01em",color:"#fff",display:"flex",alignItems:"center",gap:".42rem"}}>
                  {isLast?<><span>👁</span> Voir la réponse</>:nextH?<><span>{nextH.icon}</span> {nextH.label}</>:null}
                </div>
                {!isLast&&<div style={{fontSize:".72rem",color:"rgba(255,255,255,.6)",marginTop:".22rem",fontWeight:500}}>
                  Cet indice vaut <b style={{color:"#fff"}}>{pNow} pt{pNow>1?"s":""}</b> → le prochain n'en vaudra que <b style={{color:"#FFB340"}}>{pNxt}</b>
                </div>}
              </div>
              <div style={{width:"46px",height:"46px",borderRadius:"12px",background:isLast?"rgba(255,59,48,.18)":"rgba(255,159,10,.2)",border:`2px solid ${isLast?"rgba(255,59,48,.4)":"rgba(255,159,10,.45)"}`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.1rem",color:isLast?"#FF6961":"#FFB340",flexShrink:0,fontWeight:800}}>→</div>
            </button>

            {/* Bouton passer */}
            <button onClick={skipEntry} className="gp-sm"
              style={{padding:"12px",fontSize:".85rem",justifyContent:"center",color:"rgba(255,255,255,.7)",fontWeight:700,cursor:"pointer",textAlign:"center"}}>
    ...
    return(
      <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"2rem 1.5rem",position:"relative",zIndex:1,textAlign:"center"}}>
        ...
        <div className="afu" style={{width:"100%",maxWidth:"400px"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:".55rem"}}>
            <button onClick={()=>doShare(isFr?"france":"world",{score,results:Array.from({length:played},(_,i)=>i<rOk?10:0)})}
              style={{width:"100%",padding:"15px",borderRadius:"15px",border:"none",cursor:"pointer",fontWeight:800,fontSize:"1rem",color:"#fff",
                background:"linear-gradient(135deg,#0066FF,#3B9EFF)",boxShadow:"0 0 0 1px rgba(255,255,255,.15),0 6px 20px rgba(0,102,255,.5)"}}>
              📲 Partager mon score
            </button>
            {shareMsg&&<div style={{fontSize:".78rem",color:"#32D74B",fontWeight:700}}>{shareMsg}</div>}
            <div style={{display:"flex",gap:".65rem",justifyContent:"center"}}>
              <button className="btn btn-blue" onClick={()=>startGame(cfg)} style={{fontSize:".95rem",padding:"14px 30px",flex:1}}>🔄 Rejouer</button>
